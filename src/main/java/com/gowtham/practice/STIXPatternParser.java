...
public class STIXPatternParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'ISSUBSET'", "'LAST'", "'IN'", "'START'", "'STOP'", "'SECONDS'", "'true'", 
			"'false'", "'WITHIN'", "'REPEATS'", "'TIMES'", null, null, null, null, 
			"'<'", "'<='", "'>'", "'>='", "'''", "':'", "'.'", "','", "')'", "'('", 
			"']'", "'['", "'+'", null, "'-'", "'^'", "'/'", "'*'"
		};
	}
	...
	public static class PatternContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(STIXPatternParser.EOF, 0); }
	...
	public static class StartStopQualifierContext extends ParserRuleContext {
		...
		public List<TerminalNode> TimestampLiteral() { return getTokens(STIXPatternParser.TimestampLiteral); }
	...
	public static class WithinQualifierContext extends ParserRuleContext {
		...
		public TerminalNode IntPosLiteral() { return getToken(STIXPatternParser.IntPosLiteral, 0); }
		public TerminalNode FloatPosLiteral() { return getToken(STIXPatternParser.FloatPosLiteral, 0); }
	...
	public static class IndexPathStepContext extends ObjectPathComponentContext {
		...
		public TerminalNode RBRACK() { return getToken(STIXPatternParser.RBRACK, 0); }
		public TerminalNode IntPosLiteral() { return getToken(STIXPatternParser.IntPosLiteral, 0); }
		public TerminalNode IntNegLiteral() { return getToken(STIXPatternParser.IntNegLiteral, 0); }
	...
	public static class KeyPathStepContext extends ObjectPathComponentContext {
		public TerminalNode DOT() { return getToken(STIXPatternParser.DOT, 0); }
		public TerminalNode IdentifierWithoutHyphen() { return getToken(STIXPatternParser.IdentifierWithoutHyphen, 0); }
		public TerminalNode StringLiteral() { return getToken(STIXPatternParser.StringLiteral, 0); }
	...
	public static class OrderableLiteralContext extends ParserRuleContext {
		...
		public TerminalNode IntNegLiteral() { return getToken(STIXPatternParser.IntNegLiteral, 0); }
		public TerminalNode FloatPosLiteral() { return getToken(STIXPatternParser.FloatPosLiteral, 0); }
		public TerminalNode FloatNegLiteral() { return getToken(STIXPatternParser.FloatNegLiteral, 0); }
		public TerminalNode StringLiteral() { return getToken(STIXPatternParser.StringLiteral, 0); }
	...
	public static final String _serializedATN =
		...
		"\3\2\2\2\u00ac\21\3\2\2\2\u00ad\u00ae\7\26\2\2\u00ae\u00af\7\13\2\2\u00af"+
		"\u00b0\7\27\2\2\u00b0\u00b1\7\13\2\2\u00b1\23\3\2\2\2\u00b2\u00b3\7\33"+
